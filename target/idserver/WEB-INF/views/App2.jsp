...
<br>	
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap"><img width="20%" src="http://115.28.42.231:8080/idserver/resources/img/n7100.jpg" align="absmiddle">&nbsp;<a href="http://my-app.oss-cn-hangzhou.aliyuncs.com/SensorAppNote2V2.apk">Note 2(版本:1208)</a>&nbsp;&nbsp;<a href="http://my-app.oss-cn-hangzhou.aliyuncs.com/MSensorAppV2.apk">Note2(磁感应版)</a></li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap">-------------------------</li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap"><img width="20%" src="http://115.28.42.231:8080/idserver/resources/img/i9300.jpg" align="absmiddle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://my-app.oss-cn-hangzhou.aliyuncs.com/SensorAppS3V2.apk">S3(版本:1208)</a></li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap">-------------------------</li>
	...
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap">-------------------------</li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap"><img width="20%" src="http://115.28.42.231:8080/idserver/resources/img/xiaomi3.jpg" align="absmiddle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://my-app.oss-cn-hangzhou.aliyuncs.com/SensorAppV2.apk">小米3</a>&nbsp;&nbsp;<a href="http://my-app.oss-cn-hangzhou.aliyuncs.com/MSensorAppV2.apk">小米3(磁感应版)</a></li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap">-------------------------</li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap"><img width="20%" src="http://115.28.42.231:8080/idserver/resources/img/hongmi.jpg" align="absmiddle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://my-app.oss-cn-hangzhou.aliyuncs.com/SensorAppV2.apk">红米</a></li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap">-------------------------</li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap"><img width="20%" src="http://115.28.42.231:8080/idserver/resources/img/miaomi2.jpg" align="absmiddle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://my-app.oss-cn-hangzhou.aliyuncs.com/SensorAppV2.apk">小米2</a></li>
	<li style="text-align:center;font-size:1.0em" nowrap="nowrap">-------------------------</li>
	</div>
